...
class SettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $options = [
            ...
            // Site logo and icons.
            ['option_name' => 'site_logo_lite', 'option_value' => '/images/logo/spidest-dashboard.png'],
            ['option_name' => 'site_logo_dark', 'option_value' => '/images/logo/spidest-dashboard-dark.png'],
